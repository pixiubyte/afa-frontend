  ...
  <view class="uni-navbar" :class="{ 'uni-dark': dark }">
    ...
    >
      ...
      >
		...
		<view v-if="tools == 'logo'" class="ss-flex-1" style="display: flex;align-items: center;justify-content: center;height:100%;padding-right: 17vw;">
		  <slot name="center">
		   <image src="@/static/title.png" style="width: 123rpx;" mode="widthFix"></image>
		  </slot>
		</view>
